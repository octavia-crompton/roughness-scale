...
out_name = "runaround_smooth_band"
...
def call_SWOF(sdict):
    ...
    elif p0.veg_type == "band":
        veg = write_veg_h_stripe(p0, sim_dir)

    elif p0.veg_type == "v_band":
        p0.stripe_count = p0.stripe_count/2
        veg = write_veg_v_stripe(p0, sim_dir)        
